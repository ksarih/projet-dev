En observant les intensités de trafic pour 2022 et 2024, on constate une diminution générale dans plusieurs quartiers.
Par exemple, "Prés d'Arènes" et "Mosson" présentent des intensités relativement faibles en 2024 par rapport à 2022, ce qui pourrait refléter une réduction de l'activité cycliste dans ces zones au cours de cette période.

D'autre part, le quartier "Centre" continue d'afficher une intensité élevée, bien que celle-ci ait légèrement diminué en 2024 par rapport à 2022. 
Des baisses similaires sont observées dans d'autres secteurs, comme "Croix d'Argent" et "Port Marianne", où l'intensité du trafic est moins prononcée en 2024.

Cette évolution suggère que, bien que certaines zones maintiennent une activité cycliste relativement stable, d'autres semblent avoir vu une réduction de leur trafic au fil des ans, probablement en raison de divers facteurs contextuels comme les aménagements urbains ou l'évolution des comportements de mobilité.
